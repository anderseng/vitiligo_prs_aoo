...
plot1a <- ggplot(analysis_df, aes(y = VITageonset,
  ...
  geom_text(aes(label = str_c("P-value = ", "1.59e-15")),
             x = 4.9, y = 85, hjust = 1, vjust = 1, size = 2.5, color = "black") +
  geom_text(aes(label = str_c("\u03B2 = ", "-2.37")),
          x = 4.9, y = 80, hjust = 1, vjust = 1, size = 2.5, color = "black")
...
plot1c <- ggplot(categorized_only_analysis_df, aes(y = VITageonset,
  ...
  labs(title = paste("Age-of-Onset ~ PRS",
                     "Stratified by High-Risk MHC",
                     "Haplotype Carrier Status", sep="\n"),
       x = "Vitiligo PRS (MHC Class II Excluded)",
       y = "Vitiligo Age-of-Onset",
       color = "Age-of-Onset Category") +
    theme_bw() +
  ...
  geom_text(data = strat_hap_aoo_results_df,
          ...
          x = 4.5, y = 80, hjust = 1, vjust = 1, size =3, color = "black") +
  guides(color = FALSE) +
...
```{r include=FALSE}
ggsave(str_c(here(), "/figures/fig2.eps"), height = 5, width = 5, units = "in")
